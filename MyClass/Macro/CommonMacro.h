...
// 判断是否是iphone型号
#define IPHONE (INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone)
#define SCREEN_MAX_LENGTH (MAX(SCREEN_WIDTH, SCREENH_HEIGHT))
/// 手机类型相关
#define IS_IPHONE_4_OR_LESS  (IPHONE && SCREEN_MAX_LENGTH  < 568.0)
#define IS_IPHONE_5          (IPHONE && SCREEN_MAX_LENGTH == 568.0)
#define IS_IPHONE_6          (IPHONE && SCREEN_MAX_LENGTH == 667.0)
#define IS_IPHONE_6P         (IPHONE && SCREEN_MAX_LENGTH == 736.0)
#define IS_IPHONE_X          (IPHONE && SCREEN_MAX_LENGTH == 812.0)

// 适配导航条
#define APPLICATION_TOP_BAR_HEIGHT (IS_IPHONE_X?88.0f:64.0f)
/// tabBar高度
#define APPLICATION_TAB_BAR_HEIGHT (IS_IPHONE_X?83.0f:49.0f)
/// 工具条高度 (常见的高度)
#define APPLICATION_TOOL_BAR_HEIGHT_44  44.0f
#define APPLICATION_TOOL_BAR_HEIGHT_49  49.0f
/// 状态栏高度
#define APPLICATION_STATUS_BAR_HEIGHT (IS_IPHONE_X?44:20.0f)
